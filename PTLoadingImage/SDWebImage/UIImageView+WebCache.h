...
@property (nonatomic, strong) UILabel *ratioProgress;// 已下载百分比
@property (nonatomic, strong) UIView *progress; // loading扇形的底view
@property (nonatomic, strong) CABasicAnimation *pathAniamtion;// loading的动画
@property (nonatomic, assign) float lastRatio;// 上次的ratio
@property (nonatomic, assign) CAShapeLayer *shapeLayer;// 扇形
